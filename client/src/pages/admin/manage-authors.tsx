          ...
          <div className="space-y-3">
            <div>
              ...
              <Input
                ...
                data-testid="input-new-author-name"
              />
            </div>
            <div>
              ...
              <Input
                ...
                placeholder="https://..."
                data-testid="input-new-author-photo"
              />
            </div>
            <div>
              ...
              <Textarea
                ...
                data-testid="input-new-author-bio"
              />
            </div>
            <div className="flex gap-2">
              <Button
                onClick={() => createMutation.mutate({ name: newName, photo: newPhoto, bio: newBio })}
                disabled={!newName || createMutation.isPending}
                data-testid="button-save-new-author"
              >
              ...
              {editingId === author.id ? (
                <div className="space-y-3">
                  <div>
                    ...
                    <Input
                      ...
                      data-testid={`input-edit-author-name-${author.id}`}
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      data-testid={`input-edit-author-photo-${author.id}`}
                    />
                  </div>
                  <div>
                    ...
                    <Textarea
                      ...
                      className="resize-none"
                      data-testid={`input-edit-author-bio-${author.id}`}
                    />
                  </div>
                  {editPhoto && (
                    <img src={editPhoto} alt="Preview" className="w-16 h-16 rounded-full object-cover" />
                  )}
                  <div className="flex gap-2">
                    <Button
                      size="sm"
                      onClick={() => updateMutation.mutate({ id: author.id, data: { name: editName, photo: editPhoto, bio: editBio } })}
                      disabled={!editName || updateMutation.isPending}
                      data-testid={`button-save-edit-author-${author.id}`}
                    >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {author.bio && (
                      <p className="text-sm text-muted-foreground line-clamp-2" data-testid={`text-author-bio-${author.id}`}>{author.bio}</p>
                    )}
                  </div>
